...
CREATE TABLE ubicacion_pm(id INT AUTO_INCREMENT, 
...
CREATE TABLE foto_puntomuestral(
	id INT AUTO_INCREMENT, 
	id_punto INT, 
	nombre VARCHAR(100), 
	PRIMARY KEY (id),
	FOREIGN KEY (id_punto) REFERENCES punto_muestral(pumu_id)
);

CREATE TABLE tipo_area_pm(
	id INT AUTO_INCREMENT,
	nombre VARCHAR(20),
	PRIMARY KEY (id)
);

CREATE TABLE tiempo_pm(
	id INT AUTO_INCREMENT,
	nombre VARCHAR (20),
	PRIMARY KEY (id)
);

CREATE TABLE emision_dominante_pm(
	id INT AUTO_INCREMENT,
	nombre VARCHAR (20),
	PRIMARY KEY (id)
);

CREATE TABLE clima_pm(
	id INT AUTO_INCREMENT,
	nombre VARCHAR(20),
	PRIMARY KEY (id)
);

CREATE TABLE macrolocalizacion_pm(
	id INT AUTO_INCREMENT, 
	id_tipo_area INT, 
	id_tiempo INT, 
	...
	trafico_diario_2 BOOLEAN,
	velocidad_promedio DOUBLE,
	porcentaje_vehiculos_pesados INT,
	estado_via VARCHAR(30),
	tiempo_muestreo INT,
	tipo VARCHAR (30),
	...
	FOREIGN KEY (id_emision_dominante) REFERENCES emision_dominante_pm(id),
	FOREIGN KEY (id_clima) REFERENCES clima_pm(id)
);

CREATE TABLE criterio_pm(
	id INT AUTO_INCREMENT,
	nombre VARCHAR (200),
	PRIMARY KEY (id)
);

CREATE TABLE datos_adicionales_pm(
	id INT AUTO_INCREMENT,
...
CREATE TABLE microlocalizacion_pm(
	id INT AUTO_INCREMENT,
	fechaCreado DATETIME,
	PRIMARY KEY (id)
);

CREATE TABLE datosadicionales_microlocalizacion(
	id INT AUTO_INCREMENT,
	id_datos_adicionales INT,
	id_microlocalizacion INT,
	PRIMARY KEY (id),
	FOREIGN KEY (id_datos_adicionales) REFERENCES datos_adicionales_pm(id),
	FOREIGN KEY (id_microlocalizacion) REFERENCES microlocalizacion_pm(id)
);

CREATE TABLE criterio_microlocalizacion(	
	id INT AUTO_INCREMENT,
	id_microlocalizacion INT,
	id_criterio INT,
	cumple_criterio BOOLEAN,
	observacion_criterio VARCHAR(60),
	PRIMARY KEY (id),
	FOREIGN KEY (id_microlocalizacion) REFERENCES microlocalizacion_pm(id),
	FOREIGN KEY (id_criterio) REFERENCES criterio_pm(id)
);
CREATE TABLE item_pm(
	id INT AUTO_INCREMENT,
	nombre VARCHAR(60),
...
CREATE TABLE logistica_pm(
	id INT AUTO_INCREMENT,
	descripcion_ruta VARCHAR (60),
	PRIMARY KEY (id)
);

CREATE TABLE item_logistica(
	id INT AUTO_INCREMENT,
	id_item INT,
	id_logistica INT,
	...
	PRIMARY KEY (id),
	FOREIGN KEY (id_item) REFERENCES item_pm(id),
	FOREIGN KEY (id_logistica) REFERENCES logistica_pm(id)
);
...
INSERT INTO tiempo_pm (nombre) VALUES 
("Fija"),("Indicativa");

INSERT INTO emision_dominante_pm (nombre) VALUES 
("Tráfico"),("Punto critico"),("Industrial"),("De fondo");

INSERT INTO clima_pm (nombre) VALUES 
("Seco"),("Humedo");

INSERT INTO criterio_pm (nombre) VALUES 
("Condiciones de seguridad."),
("Exposición de los toma-muestras y sensores."),
("Condiciones de logística."),
("Cercanía a zona de parqueo, depositos de quimicos, o de combustibles."),
...
INSERT INTO item_pm (nombre, descripcion) VALUES 
("Distancia a cabecera municipal.", "Kms"),
("Cobertura 3G.", "Empresa (Claro, Tigo, Movistar)"),
("Tipo de acceso para unidad móvil.", "(Destapado, Pavimento, Otros)"),
("Horario de atención.","Desde - Hasta"),
("Distancia al punto de conexión.","Mts"),
("Distancia a estación de servicio más cercana.", "Kms"),
("Tiempo de acceso a punto de monitoreo.","Minutos"),
("Condiciones de seguridad.","(Sí, no, cuales)");
...
INSERT INTO municipio (id, nombre, estado, id_departamento)
VALUES
	(1,'Abriaquí',1,5),
	(2,'Acacías',1,50),
	(3,'Acandí',1,27),
