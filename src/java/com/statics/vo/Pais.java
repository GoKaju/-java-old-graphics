...
@NamedQueries({
    ...
    , @NamedQuery(name = "Pais.findByKConversion", query = "SELECT p FROM Pais p WHERE p.kConversion = :kConversion")})
public class Pais implements Serializable {
    ...
    @Column(name = "k_conversion")
    private Double kConversion;
    ...
    public String toString() {
        return "com.statics.vo.Pais[ id=" + id + " ]";
    }
